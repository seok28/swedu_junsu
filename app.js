...
const playViewButton = document.querySelector("#playViewButton");
...
function showManualView(category = selectedCategory) {
  currentView = "manual";
  ...
  playViewButton.classList.remove("is-active");
...
function showPlayView() {
  currentView = "play";
  manualView.classList.add("is-hidden");
  playView.classList.remove("is-hidden");
  openFormButton.classList.add("is-hidden");
  pageEyebrow.textContent = "Playground";
  pageTitle.textContent = "놀이";
  document.querySelectorAll(".category").forEach((item) => item.classList.remove("is-active"));
  playViewButton.classList.add("is-active");
  startGame();
}
...
categoryList.addEventListener("click", (event) => {
  ...
  showManualView(button.dataset.category);
});
...
playViewButton.addEventListener("click", showPlayView);
